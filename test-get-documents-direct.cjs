...
async function testGetDocumentsDirect() {
  try {
    console.log('🔍 Test direct de l\'endpoint GET /api/users/:id/documents...\n');

    // Tester l'endpoint GET /api/users/:id/documents avec un token valide
