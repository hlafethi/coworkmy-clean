-- Migration O2Switch - Version ultra-basique
-- Compatible PostgreSQL 9.6.22 et versions antérieures

-- 1. Suppression des tables existantes (sans IF EXISTS)
...
DROP VIEW booking_summary CASCADE;
