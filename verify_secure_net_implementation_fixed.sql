-- Vérification de l'implémentation de sécurisation alternative de pg_net (CORRIGÉ)
...
SELECT 
    ...
    CASE 
        WHEN extnamespace::regnamespace = 'public'::regnamespace THEN '⚠️ Dans public (normal pour pg_net)'
