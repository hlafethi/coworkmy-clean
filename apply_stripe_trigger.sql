-- Script pour ajouter la synchronisation automatique Stripe
...
-- Créer la table application_logs si elle n'existe pas
...
-- Activer RLS sur application_logs
ALTER TABLE public.application_logs ENABLE ROW LEVEL SECURITY;

-- Politique pour les logs (seuls les admins peuvent voir)
