...
// Copier-coller ce code dans la console de ton navigateur

console.log('🧹 Début du nettoyage des URL blob...');

// Récupérer les variables d'environnement Supabase depuis l'app
const supabaseUrl = window.location.hostname === 'localhost' 
  ? 'http://localhost:54321' 
  : 'https://your-project.supabase.co';
const supabaseKey = 'your-anon-key'; // À remplacer par ta vraie clé
