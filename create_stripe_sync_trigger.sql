-- Script pour créer le trigger de synchronisation automatique Stripe
-- Ce trigger appelle l'edge function 'sync-space-stripe' à chaque INSERT/UPDATE/DELETE sur la table 'spaces'
...
-- 4. Test du trigger (optionnel - décommentez pour tester)
