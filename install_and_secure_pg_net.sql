-- Installation et sécurisation de pg_net
-- Script complet pour gérer l'extension pg_net
...
-- 7. Créer une vue de surveillance
...
SELECT 
    ...
    CASE 
        WHEN EXISTS (
            ...
            WHERE extname = 'pg_net' AND extnamespace::regnamespace = 'public'::regnamespace
