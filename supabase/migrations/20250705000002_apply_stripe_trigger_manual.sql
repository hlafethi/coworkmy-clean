-- Migration pour appliquer manuellement le trigger de synchronisation Stripe
-- Ce script force la création du trigger même si les migrations précédentes ont échoué
